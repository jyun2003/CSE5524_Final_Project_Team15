...
def apply_gkernel(inp_img, ker_sz=5, ksigma_vals=[0.05 + i for i in range(5)]):
    """
    ...
    return torch.clamp(blurry, 0.0, 1.0), kernel
...
def apply_psf(inp_img, kernels):
    ...
    idx = np.random.choice(
        np.arange(11), p=[0.091, 0.091, 0.091, 0.091, 0.091, 0.091, 0.091, 0.091, 0.091, 0.091, 0.09]
    )
    ...
    return torch.clamp(blurry, 0.0, 1.0)
